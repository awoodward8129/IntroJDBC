...
public class BookDB_Sample {
	...
	public static void main(String[] args) {
		...
		BookDB_Sample db = new BookDB_Sample();
		db.driverClassName = "com.mysql.jdbc.Driver";
		db.url = "jdbc:mysql://localhost:3306/book_db";
                //root
		db.userName = "root";
                //admin
		db.password = "admin";
		...
		try {
			...
			while( rs.next() ) {
                      System.out.println("\nRecord No: " + (count + 1));
				System.out.println( "Book ID: " + rs.getInt("book_id") ); // named field
				System.out.println( "Author Name: " + rs.getString("author") ); // named field
